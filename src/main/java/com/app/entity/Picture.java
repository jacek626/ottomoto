...
public class Picture {
	...
	public boolean isMainPhotoInAnnouncement() {
		return mainPhotoInAnnouncement;
	}

	public void setMainPhotoInAnnouncement(boolean mainPhotoInAnnouncement) {
		this.mainPhotoInAnnouncement = mainPhotoInAnnouncement;
	}
