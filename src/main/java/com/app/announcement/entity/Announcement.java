...
public class Announcement implements EntityForSearchStrategy {
    ...
    public AnnouncementSearchFields getSearchFields() {
        return searchFields == null ? searchFields = new AnnouncementSearchFields() : searchFields;
    }

    public VehicleType getVehicleType() {
        return vehicleType == null ? (vehicleModel == null ? VehicleType.CAR : vehicleModel.getVehicleType()) : vehicleType;
    }
